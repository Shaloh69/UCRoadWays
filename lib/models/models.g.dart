...
Map<String, dynamic> _$NavigationRouteToJson(NavigationRoute instance) =>
    <String, dynamic>{
      ...
      'floorTransitions': instance.floorTransitions,
    };
...
FloorTransition _$FloorTransitionFromJson(Map<String, dynamic> json) =>
    FloorTransition(
      fromFloorId: json['fromFloorId'] as String,
      toFloorId: json['toFloorId'] as String,
      buildingId: json['buildingId'] as String,
      transitionPoint:
          LatLng.fromJson(json['transitionPoint'] as Map<String, dynamic>),
      transitionType: json['transitionType'] as String,
      landmarkId: json['landmarkId'] as String,
      instructions: json['instructions'] as String,
    );

Map<String, dynamic> _$FloorTransitionToJson(FloorTransition instance) =>
    <String, dynamic>{
      'fromFloorId': instance.fromFloorId,
      'toFloorId': instance.toFloorId,
      'buildingId': instance.buildingId,
      'transitionPoint': instance.transitionPoint,
